 ...
 */
@RestController
public class CarManagerInController {
    @Autowired
    private CarManagerService carManagerService;
    @GetMapping("initCarManagerIn")
    ...
    @RequestMapping("/carManagerInAdd")
    @ResponseBody //一定要添加此注解
    public void add(Car c){
        carManagerService.add(c);
    }

    @RequestMapping("/carManagerInUpdate")
    @ResponseBody //一定要添加此注解
    public void update(Car c){
        System.out.println("#########################");
        carManagerService.update(c);
    }
    @RequestMapping("/carManagerIn/{carManagerDel}")
    @ResponseBody //一定要添加此注解
