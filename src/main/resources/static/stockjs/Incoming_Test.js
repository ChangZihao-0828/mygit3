layui.use('table', function(){
    ...
    table.render({
        ...
        ,loading:true
        ,cols: [[ //表头
            {field: 'examine_goods_id', title: '编号', width:"20%", sort: true, fixed: 'left',align:"center"}
            ,{field: 'in_goods_id', title: '入库作业单编号', width:"20%", sort: true, fixed: 'left',align:"center"}
            ,{field: 'in_equip_goods_id', title: '入库装卸单单编号', width:"20%", sort: true, fixed: 'left',align:"center"}
            ,{field: 'examine_goods_people', title: '验货人', width:"10%",align:"center", sort: true}
            ,{field: 'examine_goods_time', title: '完成时间', width:"10%",align:"center", sort: true,templet:'<div>{{ layui.util.toDateString(d.bir, "yyyy-MM-dd") }}</div>'}
            ,{field: 'examine_goods_remark', title: '备注', width:"10%",align:"center"}
        ...
        switch (obj.event) {
            case 'add':
                layer.open({
                    ...
                    anim: 1,
                    title: "添加入库作业单",
                    content: '/stock/add_Incoming_test',
